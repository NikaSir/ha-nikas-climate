    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box} button{font:inherit}
        .shell{position:absolute;inset:0;display:grid;grid-template-rows:calc(60px + env(safe-area-inset-top)) minmax(0,1fr) 52px calc(64px + env(safe-area-inset-bottom));background:var(--primary-background-color);overflow:hidden}
