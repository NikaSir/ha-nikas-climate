...
(async()=>{
 ...
 try {
  ...
  const measure=async name=>{
   ...
   expect(g.circleCSS,{position:'absolute',top:'-92px',right:'-70px',width:'205px',height:'205px',borderRadius:'50%',backgroundColor:'color(srgb 0.881412 0.959529 0.982118)',opacity:'1',borderTopWidth:'0px',boxShadow:'none',filter:'none',transform:'none',animationName:'none'});
